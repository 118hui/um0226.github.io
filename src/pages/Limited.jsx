    ...
    <section>
      <div className='container px-5 py-24 mx-auto'>
        <div className='flex flex-col text-center w-full mb-12'>
          <h1 className='sm:text-3xl text-2xl font-bold title-font mb-4 text-gray-900'>期間限定課程</h1>
          <p className='lg:w-2/3 mx-auto leading-relaxed text-base'>季節性限定課程、臨時性辦理課程介紹</p>
        </div>
          ...
          <div className='grid gap-8 lg:grid-cols-3 sm:max-w-sm sm:mx-auto lg:max-w-full'>
            <div className='overflow-hidden transition-shadow duration-300 bg-white rounded shadow-sm'>
              ...
              <div className='p-5 border border-t-0'>
                ...
                <NavLink exact to='/four'>
                  <button aria-label='' className='inline-flex items-center font-semibold transition-colors duration-200 text-deep-purple-accent-400 hover:text-amber-500'>
                    課程介紹
                  </button>
                </NavLink>
              </div>
