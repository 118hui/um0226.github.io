      ...
      <div className='w-full h-screen'>
        ...
        <div className='absolute top-0 w-full h-full flex flex-col justify-center item text-white'>
          <div className='md:left-[10%] max-w-[1100px] m-auto absolute p-4'>
            ...
            <NavLink to='/serve' activeClassName='active'>
              <button className='w-40 h-12 bg-[#f1a706] cursor-pointer rounded-3xl border-2 border-[#f1a706] shadow-[inset_0px_-2px_0px_1px_#f1a706] group  transition duration-300 ease-in-out'>
                <span className='font-medium text-lg text-white group-hover:text-black'>服務項目</span>
              </button>
            </NavLink>
            <NavLink to='/member' activeClassName='active'>
              <button className='m-3 w-40 h-12 bg-white cursor-pointer rounded-3xl  hover:bg-[#f1a706] transition duration-300 ease-in-out'>
                <span className='font-medium text-lg text-black'>會員登入</span>
              </button>
            </NavLink>
          </div>
        </div>
